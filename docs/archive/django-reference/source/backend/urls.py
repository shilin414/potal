...
urlpatterns += [
    ...
    # Django admin lives at /django-admin/ so future business admin
    # consoles can claim /admin/*.
    ...
    # Identity: Feishu OAuth (default user entry) + /login/admin backend
    ...
    # v2 unified execution API (runs / events / SSE / artifacts)
    path('api/v2/', include('apps.execution.urls')),
]
